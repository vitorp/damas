...
option_text_addr:
	...
	andi t1, s0, 0x01
	beq t1, zero, eat_up_even_row
	la a0, eat_up_right_text
	j end_option_text_addr
	eat_up_even_row:
	la a0, eat_up_left_text
	j end_option_text_addr
	not_eat_up:
	...
	andi t1, s0, 0x01
	beq t1, zero, eat_down_even_row
	la a0, eat_down_right_text
	j end_option_text_addr
	eat_down_even_row:
	la a0, eat_down_left_text
	j end_option_text_addr
	not_eat_down:
	...
	andi t1, s0, 0x01
	beq t1, zero, eat_adj_up_even_row
	la a0, eat_up_left_text
	j end_option_text_addr
	eat_adj_up_even_row:
	la a0, eat_up_right_text
	...
	andi t1, s0, 0x01
	beq t1, zero, eat_adj_down_even_row
	la a0, eat_down_left_text
	j end_option_text_addr
	eat_adj_down_even_row:
	la a0, eat_down_right_text
	j end_option_text_addr
	not_eat_adj_down:
